export default function TermsOfService() {
  return (
    <div className="container mx-auto text-gray-200">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Tipsy HC.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Tipsy HC, accessible from{' '}
            <a
              href="https://tipsy.tobiaslafleur.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://tipsy.tobiaslafleur.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: tobias.lafleur98@gmail.com</li>
      </ul>
    </div>
  );
}
